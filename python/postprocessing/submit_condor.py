...
def sub_writer(sample, n, files, folder):
    ...
    f.write("transfer_input_files    = $(Proxy_path), samples/samples.py, skimtree_utils_ssWW_wFakes.py, CutsAndValues_bu.py, FR_vsjet4_new.root, ./data/leptonSF/Muon_RunBCDEF_SF_ID_2017.root, ./data/leptonSF/Muon_RunBCDEF_SF_ISO_2017.root, ./data/leptonSF/Electron_MVA90_2017.root, ./data/leptonSF/EGM2D_2017_passingRECO_lowEt.root, ./data/leptonSF/EGM2D_2017_passingRECO_highEt.root, __init__.py\n")
