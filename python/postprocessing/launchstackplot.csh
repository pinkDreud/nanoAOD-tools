...
##python makeplot.py -y 2017 --lep electron --bveto -f $folder -s --wfake incl_vsjet4 --signal --notstacked #--blinded 
...
#python makeplot.py -y 2017 --lep electron --ttbar -f $folder -s --wfake incl_vsjet4 --cut "BDT_output<-0.425"
#python makeplot.py -y 2017 --lep electron --ttbar -f $folder -s --wfake sep --cut "BDT_output<-0.425"
#python makeplot.py -y 2017 --lep electron --ttbar -f $folder -s --wfake incl_vsjet4 --cut "BDT_output_ele<-0.536"
...
##python makeplot.py -y 2017 --lep muon --bveto -f $folder -s --wfake incl_vsjet4 --signal --notstacked #--blinded
#python makeplot.py -y 2017 --lep muon --bveto -f $folder -s --wfake incl_vsjet4 --cut "BDT_output>-0.425" #--blinded
#python makeplot.py -y 2017 --lep muon --bveto -f $folder -s --wfake sep --cut "BDT_output>-0.425" #--blinded
#python makeplot.py -y 2017 --lep muon --bveto -f $folder -s --wfake incl_vsjet4 --cut "BDT_output_mu>-0.399" #--blinded
...
#python makeplot.py -y 2017 --lep muon --wjets -f $folder -s --wfake incl_vsjet4 --cut "BDT_output<-0.425"
#python makeplot.py -y 2017 --lep muon --wjets -f $folder -s --wfake sep --cut "BDT_output<-0.425"
#python makeplot.py -y 2017 --lep muon --wjets -f $folder -s --wfake incl_vsjet4 --cut "BDT_output_mu<-0.399"
