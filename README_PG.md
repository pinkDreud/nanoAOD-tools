# nanoAOD-tools: PG Version
Tools for working with NanoAOD (requiring only python + root, not CMSSW)

First of all, make sure you are in the branch named "VBS_PG" and not "master".
If you are reading this, you should already be in the branch "VBS_PG".

After that, fork my nanoAOD-tools repo and check that in your github you have the nanoAOD-tools repo. If yes, verify VBS_PG is the default branch, otherwise make VBS_PG that via "Settings" menu.

You can now log in your lxplus
